		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 Data binding",
									"targetURL": "#sapui5databinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5databinding-display": {
								"semanticObject": "sapui5databinding",
								"action": "display",
								"description": "A Fiori application with data binding",
								"title": "SAP UI5 Data binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5databinding",
									"url": sap.ui.require.toUrl("sapui5databinding")
								}
							}
						}
					}
